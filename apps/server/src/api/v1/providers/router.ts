...
export default function createProviderRouter(controller: ProviderController) {
  ...
  router.post(
    "/:providerId/refresh",
    controller.refreshProvider.bind(controller),
  );
  ...
  router.post(
    "/:providerId/services/bulk",
    controller.bulkAddServices.bind(controller),
  );
  router.get(
    "/:providerId/discover-services",
    controller.discoverServices.bind(controller),
  );
