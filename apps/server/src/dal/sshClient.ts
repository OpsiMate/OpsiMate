...
// REMOVED: These imports and logic caused the TS1343 error during Jest compilation
...
// REMOVED: const __dirname = dirname(__filename);
// We rely on the global __dirname variable provided by Node.js in the CommonJS test environment.
...
        // @ts-ignore: We rely on the global __dirname variable provided by Node.js when running tests.
...
        logger.info(`[DEBUG] Service ${serviceName} status: '${statusOutput.split('\n')[2] || statusOutput.split('\n')[1] || 'No status line found'}'`);
