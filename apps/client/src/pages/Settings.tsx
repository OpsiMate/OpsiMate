...
const Settings: React.FC = () => {
  ...
  const handleRoleUpdate = async (email: string, newRole: Role) => {
    ...
    try {
      const response = await apiRequest("/users/role", "PATCH", {
        email,
        newRole,
      });
      if (response.success) {
                ...
                <div className="flex-1">
                    ...
                    <div className="flex justify-between items-center gap-4">
                      <div className="flex-1">
                        ...
                        <p className="text-muted-foreground">
                          Manage user access and permissions for your Service
                          instance.
                        </p>
                      </div>
                  ...
                  <TabsContent value="audit" className="space-y-6">
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        View activity logs for all dashboard operations and user
                        actions.
                      </p>
                    </div>
                    <Card>
                  ...
                  <TabsContent value="secrets" className="space-y-6">
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-muted-foreground">
                          Manage SSH keys and kubeconfig files used to access
                          providers and services securely.
                        </p>
                      </div>
                      <AddSecretButton />
                    </div>
                  ...
                  <TabsContent value="custom-fields" className="space-y-6">
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Create and manage custom fields for your services. These
                        fields can store additional information like
                        environment, version, or any other metadata.
                      </p>
                    </div>
                    <Card>
                      <CardHeader>
              ...
              {filteredLogs.map((log) => {
                ...
                return (
                  <TableRow key={log.id}>
                    <TableCell>
                      <span
                        title={parseUTCDate(log.timestamp).toLocaleString()}
                      >
...
export const AddSecretButton: React.FC<AddSecretButtonProps> = ({
  ...
  const [secretType, setSecretType] = useState<"ssh" | "kubeconfig">(
    defaultSecretType,
  );
    ...
    >
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Upload a secret file (SSH key or kubeconfig). It will be encrypted
            and stored securely.
          </DialogDescription>
        </DialogHeader>
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            ...
            <Select
              value={secretType}
              onValueChange={(value: "ssh" | "kubeconfig") =>
                setSecretType(value)
              }
            >
              <SelectTrigger>
                ...
                <div className="flex items-start gap-2 p-3 bg-red-50 border border-red-200 rounded-md">
                  ...
                  <div className="text-sm text-red-700">
                    ...
                    <p className="text-red-600 mt-1">
                      This file doesn't appear to be a valid secret file. Please
                      ensure you're uploading an SSH key or kubeconfig file.
                    </p>
                  </div>
                </div>
              )}
        ...
        <DialogFooter>
          ...
          <Button
            disabled={!fileName || isFileValid === false}
            onClick={handleSave}
          >
            Save
          </Button>
...
const SslKeysTable: React.FC = () => {
  ...
  const [editingSecret, setEditingSecret] = useState<SecretMetadata | null>(
    null,
  );
  const { toast } = useToast();
  const [searchQuery, setSearchQuery] = useState("");
  ...
  useEffect(() => {
    ...
    return () =>
      window.removeEventListener("secrets-updated", handleSecretsUpdated);
  }, []);

  if (loading)
    return <div className="py-6 text-center">Loading secrets...</div>;
  if (error)
            ...
            filteredSecrets.map((secret) => (
              <TableRow key={secret.id}>
                ...
                <TableCell>
                  <Badge
                    variant={
                      secret.type === "kubeconfig" ? "secondary" : "default"
                    }
                  >
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            ...
                            <b>{secret.name}</b>"? This action cannot be undone
                            and will permanently remove the secret file.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
