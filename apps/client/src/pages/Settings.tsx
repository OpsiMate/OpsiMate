                ...
                <div className='flex-1'>
                                  ...
                                  <div className='flex items-center gap-2'>
                                    <Select
                                      ...
                                      onValueChange={newRole =>
                                        handleRoleUpdate(user.email, newRole as Role)
                                      }
                                      disabled={
                                          ...
                                          <AlertDialogContent>
                                            <AlertDialogHeader>
                                              ...
                                              <AlertDialogDescription>
                                                ...
                                                <b>{userToDelete?.fullName}</b>? This action cannot
                                                be undone.
                                              </AlertDialogDescription>
                                            </AlertDialogHeader>
                                            <AlertDialogFooter>
                  ...
                  <TabsContent value='secrets' className='space-y-6'>
                    <div className='flex justify-between items-center'>
                      <div>
                        ...
                        <p className='text-muted-foreground'>
                          Manage SSH keys and kubeconfig files used to access providers and services
                          securely.
                        </p>
                      </div>
                      <AddSecretButton />
                  ...
                  <TabsContent value='custom-fields' className='space-y-6'>
                    <div>
                      ...
                      <p className='text-muted-foreground'>
                        Create and manage custom fields for your services. These fields can store
                        additional information like environment, version, or any other metadata.
                      </p>
                    </div>
                    <Card>
                      <CardHeader>
                ...
                return (
                  <TableRow key={log.id}>
                    ...
                    <TableCell>
                      <Badge
                        variant={
                          actionProps.variant as 'default' | 'destructive' | 'outline' | 'secondary'
                        }
...
const SslKeysTable: React.FC = () => {
  ...
  if (!secrets.length)
    return <div className='py-6 text-center text-muted-foreground'>No secrets added yet.</div>;
                    ...
                    <AlertDialog>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            Are you sure you want to delete "<b>{secret.name}</b>"? This action
                            cannot be undone and will permanently remove the secret file.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
