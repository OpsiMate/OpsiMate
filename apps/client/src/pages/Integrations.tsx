...
const INTEGRATIONS: Integration[] = [
  ...
  // Removed duplicate datadog entry
  {
    ...
    name: "New Relic",
    description:
      "Observability platform built to help engineers create perfect software.",
...
const ALL_TAGS = Array.from(
  new Set(INTEGRATIONS.flatMap((integration) => integration.tags)),
);
            ...
            {filteredIntegrations.map((integration) => (
              <Card
                ...
                className={cn(
                  ...
                  hoveredCard === integration.id &&
                    configuredInstances[integration.id] &&
                    configuredInstances[integration.id] > 0
              ...
              >
                      ...
                      if (existingIntegration) {
                        ...
                        if (integration.id === "datadog") {
                          setFormData({
                            ...
                            apiKey:
                              existingIntegration.credentials?.apiKey || "",
                            appKey:
                              existingIntegration.credentials?.appKey || "",
                          });
                        } else {
                ...
                configuredInstances[integration.id] > 0 ? (
                  <div className="px-6 pb-3 flex items-center gap-1.5 text-xs text-green-600 dark:text-green-400">
                    ...
                    <span>
                      {configuredInstances[integration.id]}{" "}
                      {configuredInstances[integration.id] === 1
                        ? "instance"
                        : "instances"}{" "}
                      configured
                    </span>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground mt-1">
                            Configure your {selectedIntegration.name}{" "}
                            integration by providing the required credentials
                            below.
                          </p>
                        </div>
                      </div>
                    ...
                    >
                        ...
                        <div key={field.name} className="space-y-2">
                          ...
                          {field.type === "select" ? (
                            <select
                              ...
                              disabled={
                                isSubmitting || !canManageIntegrations()
                              }
                              autoComplete="off"
                            >
                      ...
                      <div className="pt-4 space-y-3">
                        ...
                        <p className="text-xs text-center text-muted-foreground">
                          You can configure multiple instances of the same
                          integration
                        </p>
                      </div>
                    </form>
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete the {integrationToDelete?.type}{" "}
                ...
                try {
                  ...
                  if (response.success) {
                    ...
                    const integrationType =
                      integrationToDelete.type.toLowerCase();
                    setConfiguredInstances((prev) => ({
                      ...prev,
                      [integrationType]: 0,
                    }));
