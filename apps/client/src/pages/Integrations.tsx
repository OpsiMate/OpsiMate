                      ...
                      <div className='flex items-start gap-3'>
                        ...
                        <div>
                          ...
                          <p className='text-xs text-muted-foreground mt-1'>
                            Configure your {selectedIntegration.name} integration by providing the
                      ...
                      onSubmit={async e => {
                        ...
                        try {
                          ...
                          const integrationData = {
                            ...
                            type:
                              typeMapping[selectedIntegration.id as keyof typeof typeMapping] ||
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete the {integrationToDelete?.type} integration. This action
              cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
