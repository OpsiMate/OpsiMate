          ...
          >
            ...
            <div className="flex items-center gap-1">
              ...
              <DropdownMenu
                ...
                onOpenChange={(isOpen) =>
                  setOpenMenuId(isOpen ? service.id : null)
                }
              >
                ...
                >
                  ...
                  {service.status !== "running" && (
                    <DropdownMenuItem
                      onClick={() =>
                        handleAction(service.id, "running", "Starting")
                      }
                    >
                  ...
                  {service.status === "running" && (
                    <DropdownMenuItem
                      onClick={() =>
                        handleAction(service.id, "stopped", "Stopping")
                      }
                    >
                  ...
                  <DropdownMenuItem
                    onClick={() =>
                      handleAction(service.id, "running", "Restarting")
                    }
                  >
