 ...
 */
export const getOwnerDisplayName = (ownerId: number | null | undefined, users: UserInfo[]): string => {
 ...
 */
export const getOwnerSortKey = (ownerId: number | null | undefined, users: UserInfo[]): string => {
