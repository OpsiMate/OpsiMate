				...
				<div className="flex-1 flex min-h-0 overflow-hidden">
					<div className={cn('flex flex-col p-4 min-h-0 transition-all duration-300', 'flex-1 min-w-0')}>
						<div className="shrink-0 mb-4">
							...
							{/* Wraps rather than clipping: every button in this row is shrink-0, so on a
							    narrow column (1440px with the details pane open is already one) a single
							    row squeezes the search field down to a sliver and pushes the time filter
							    out of sight. */}
