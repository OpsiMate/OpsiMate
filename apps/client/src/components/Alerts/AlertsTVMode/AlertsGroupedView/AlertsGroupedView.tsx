	...
	return (
		<motion.div
			...
			className={cn(
				...
				'bg-linear-to-br transition-all duration-150',
				color.bg,
...
export const AlertsGroupedView = ({
	...
	return (
		<div className="w-full h-full flex flex-col bg-linear-to-br from-slate-100 to-slate-200">
			{/* Header */}
			<div className="shrink-0 flex items-center justify-between px-3 py-2 bg-white/80 backdrop-blur-xs border-b border-slate-200">
