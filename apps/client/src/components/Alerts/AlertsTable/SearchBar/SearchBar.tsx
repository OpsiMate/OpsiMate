...
export const SearchBar = ({ searchTerm, onSearchChange, onAiFilter }: SearchBarProps) => {
	...
	return (
		<div className="relative min-w-0 flex-1 max-w-md">
			<div
				className={cn(
					// min-w-0 + overflow-hidden: in a cramped toolbar this wrapper collapses, and
					// without them the input's automatic minimum size (a text field is ~20
					// characters wide by default) holds the row wider than the box, so its text
