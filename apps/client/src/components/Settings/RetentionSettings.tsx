...
const RESOURCE_META: Record<RetentionResource, { title: string; description: string }> = {
	...
	[RetentionResource.RootCauses]: {
		title: 'Root cause analyses',
		description: 'Root causes pushed via the API or generated by the AI agent, with their ratings.',
	},
	[RetentionResource.EnrichmentVersions]: {
		title: 'Enrichment versions',
		description: 'Historical snapshots created whenever an enrichment rule changes.',
	},
};
