...
export const IntegrationDashboardDropdown = memo(
  function IntegrationDashboardDropdown({
    tags,
    integrationType,
    className,
            ...
            <>
              {dashboards.map((dashboard, index) => (
                <DropdownMenuItem
                  ...
                  onClick={() =>
                    handleDashboardClick(dashboard.url, dashboard.name)
                  }
                >
