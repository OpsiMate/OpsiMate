...
export const MobileWebOverlay = () => {
	...
	return (
		<div className="fixed inset-0 z-9999 flex flex-col items-center justify-center bg-linear-to-br from-slate-900 via-slate-800 to-slate-900 px-6 text-center">
			...
			<div className="relative z-10 flex max-w-sm flex-col items-center gap-8">
				...
				<div className="flex items-center gap-3 rounded-xl border border-slate-700 bg-slate-800/50 px-5 py-4 backdrop-blur-xs">
