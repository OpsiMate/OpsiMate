...
variable "k8s_master_version" {
  description = "This is the default version of EKS if not passed"
  default     = ""
}
...
variable "instance_types" {
  type        = list(any)
  description = "Used when node group type is ondemand"
  default     = ["m5.large"]
}

variable "minimum-node" {
  description = "mimimum number of nodes in asg"
  default     = "1"
}
...
variable "desired-node" {
  description = "what is the desigred number of nodes in asg"
  default     = "1"
}

variable "force_update_version" {
  type        = bool
  description = "Force Upgrade (true/false)"
  default     = false
}
variable "max_unavailable" {
  description = "Max Unavailable - Desired max number of unavailable worker nodes during node group update"
  default     = "1"
}
variable "launch_template_version" {
  description = "Launch template version to be used, default is latest"
  default     = "$Latest"
}
variable "node-ami-id" {
  description = "AMI ID of the Node to use"
  default     = ""
}
variable "k8s_ng_version" {
  type        = string
  description = "Kubernetes NG Version"
  default     = ""
}
...
variable "root_device_name" {
  description = "Device name, this may vary based on instance type, choose accordingly"
  default     = "/dev/xvda"
}
variable "key_pair_name" {
  description = "aws pem key to be used"
  default     = "opsimate-keypair"
}